...
for (sample in samples){
    data <- readRDS(glue("output/init_obj/human/{sample}.rds"))
...
saveRDS(rna_data, "output/normalized_data/human_rna_sc.rds")
saveRDS(activity_data, "output/normalized_data/human_activity_sc.rds")
...
write.csv(correlation, "output/scores/human_scores_sc.csv")